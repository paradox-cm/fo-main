    ...
    <main className="min-h-screen bg-[#0A0A0B] text-white">
      ...
      <section className="relative min-h-screen flex flex-col justify-between overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center flex-grow flex flex-col justify-center py-16 md:py-0">
          ...
          <AnimatedHeadline
            text="Disappear Into the Wild."
            className="font-tektur text-3xl md:text-6xl lg:text-7xl uppercase tracking-wide mb-4 md:mb-6 text-white"
          />

          <TypingAnimation
            text="Performance gear built for the elements. Engineered for those who move through the wild with purpose."
            className="font-mono text-base md:text-xl uppercase tracking-wider text-[#B99C20] max-w-2xl mx-auto"
            typingSpeed={150}
          />
        </div>
      ...
      <section id="intro-section" className="py-20 bg-[#0F0F10]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <TypingAnimation
              text="A new standard for concealment, durability, and outdoor performance."
              className="text-xl font-tektur uppercase tracking-wide text-center text-[#B99C20]"
              typingSpeed={150}
            />
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-[#242423]">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-6 md:mb-0">
              <Image src="/welcome/images/Forest-ICON.svg" alt="Forest Outfitters" width={60} height={60} />
              <div className="ml-4">
                <p className="font-tektur uppercase">Forest Outfitters™</p>
                <p className="text-sm text-gray-500">Crafted for the unseen. Designed for the unstoppable.</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-[#1A1A1A] hover:bg-[#B99C20]/20 transition-colors duration-300"
              ...
              <a
                href="mailto:info@forestoutfitters.com"
                className="px-6 py-2 bg-transparent border border-[#B99C20] text-[#B99C20] hover:bg-[#B99C20] hover:text-black transition-colors duration-300 font-mono uppercase text-sm tracking-wider flex items-center justify-center h-10"
              >
                Contact Us
              </a>
            </div>
