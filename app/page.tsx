...
import { NewsletterForm } from "@/app/welcome/components/newsletter-form"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <Link
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-[#242423] hover:bg-[#B99C20]/20 transition-colors"
